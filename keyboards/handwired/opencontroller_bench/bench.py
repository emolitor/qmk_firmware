...
def cmd_diag(ocd, symbols, args):
    ...
    if len(frame) < 3 + 0x41:
        ...
        return
    names = ["rf_state", "ll_boot", "pair_bcast", "valid_rx", "entered_connected", "rf_config", "pair_rx_off", "wfi", "sleep_attempt", "sleep_entered", "sleep_aborted", "wake_gpio", "wake_rtc", "last_abort", "cfg_status", "rx_status", "tx_status", "ll_drop", "boot_reset", "fault_marker", "mepc", "mcause", "mtval", "loop_passes", "loop_stage"]
    values = struct.unpack_from("<B7I5HBBBBIBBIIIHB", frame, 3)
