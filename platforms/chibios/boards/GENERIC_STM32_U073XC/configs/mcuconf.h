 ...
 * 0...3        Lowest...Highest.
 *
 * Clocking (crystal-less board): HSI16 -> PLL -> 56 MHz SYSCLK, USB fed
 * from HSI48 with CRS autotrim against the USB SOF (see board/extra.c).
 */
...
#define STM32_CLK48SEL                      RCC_CCIPR_CLK48SEL_HSI48
...
#define STM32_ADC_ADC1_IRQ_PRIORITY         3
